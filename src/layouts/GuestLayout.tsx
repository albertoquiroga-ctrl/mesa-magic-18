...
const hideNavRoutes = ['/guest/onboarding', '/guest/offline', '/guest/payment-success', '/guest/payment-failed', '/guest/early-exit', '/guest/login', '/guest/quick-pay-success', '/guest/farewell', '/guest/post-registration'];
